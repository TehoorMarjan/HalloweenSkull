...
bool Eyes::effectNormal()
{
    ...
    if (currentLeft.x < targetLeft.x) currentLeft.x++;
    if (currentLeft.x > targetLeft.x) currentLeft.x--;
    if (currentLeft.y < targetLeft.y) currentLeft.y++;
    if (currentLeft.y > targetLeft.y) currentLeft.y--;

    if (currentRight.x < targetRight.x) currentRight.x++;
    if (currentRight.x > targetRight.x) currentRight.x--;
    if (currentRight.y < targetRight.y) currentRight.y++;
    if (currentRight.y > targetRight.y) currentRight.y--;
